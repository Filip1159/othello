...
public class Main {
    public static void main(String[] args) {
        ...
        reversiEngine.addPlayer(new BotPlayer(BLACK, new CornersStrategy(board), new MinMax(), board, 6));
        reversiEngine.addPlayer(new BotPlayer(WHITE, new CornersStrategy(board), new MinMax(), board, 6));
